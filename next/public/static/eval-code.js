...
function Playerjs(options) {
	var o = window.o = {
		...
		FGeRtNzK: function(x) {
			...
			function b2(str) {
				const res = decodeURIComponent(atob(str).split("").map(function(c) {
	...
	function prtObj() {
		if (v.vast == 1 && o.p != '') { var x = JSON.parse(decode(o.p)); for (var j = 0; j < x.x.length; j++) { !exist(v[x.x[j]]) ? v[x.x[j]] = '' : ''; for (var i = 1; i < 10; i++) { var xd = v[x.x[j] + '_deny'] ? v[x.x[j] + '_deny'].split(',') : []; var xp = v['partner' + x.x[j] + '_' + i]; if (exist(xp)) { if (xp != '') { x.x[j] == 'midroll' && i == 1 ? v[x.x[j]] = '' : ''; var pp = x[xp]; if (exist(pp)) { var y = x.x[j]; y == 'midroll' ? y = 'preroll' : ''; if (v['partner' + x.x[j] + 'deny' + i] && v['partner' + x.x[j] + 'deny' + i] != '') { v['partner' + x.x[j] + 'deny' + i].split(',').indexOf(o.domain) > -1 ? pp[y] = '' : ''; } if (v['partner' + x.x[j] + 'accept' + i] && v['partner' + x.x[j] + 'accept' + i] != '') { v['partner' + x.x[j] + 'accept' + i].replace(/ /ig, '').split(',').indexOf(o.domain) == -1 ? pp[y] = '' : ''; } if (pp['id']) { if (xd.indexOf(pp['id']) > -1) { pp[y] = ''; } }; if (pp[y] && pp[y] != '') { pp[y] = pp[y].replace(' and ', ''); pp[y] = pp[y].replace('http://', '//'); if (v['partner' + x.x[j] + 'geo' + i] && v['partner' + x.x[j] + 'geo' + i] != '') { var gp = '[geo:' + v['partner' + x.x[j] + 'geo' + i] + ']'; pp[y].indexOf(gp) == -1 ? pp[y] = pp[y] + gp : ''; } var lgk = v['partner' + x.x[j] + 'or']; var lgk2 = i > 1 ? v['partner' + x.x[j] + 'or' + (i - 1)] : 'def'; if (v['partner' + x.x[j] + 'or' + i] == 'or50') { pp[y] = pp[y] + '[50%]'; v['partner' + x.x[j] + 'or' + i] = 'or'; }; if (v['partner' + x.x[j] + 'or' + i] == 'stop') { pp[y] = pp[y] + '[stop]'; v['partner' + x.x[j] + 'or' + i] = 'and'; }; var prtvx = 'prt' + (exist(pp['cpm']) ? 'cpm' + pp['cpm'] : '') + (xp.indexOf('myvast') == 0 ? xp : pp['title'].substr(0, pp['title'].indexOf(' '))) + (exist(pp['imp']) ? '[imp]' + pp['imp'] : '') + '_' + (exist(pp['pimp']) ? '[pimp]' + pp['pimp'] + '**' : '') + pp[y]; if (x.x[j] == 'midroll') { v['midroll' + (i == 1 ? '' : i)] = prtvx; } else { v[x.x[j]] += (v[x.x[j]] != '' ? ' ' + (exist(lgk2) ? (lgk2 != 'def' ? lgk2 : lgk) : lgk) + ' ' : '') + prtvx; } } } } } } }; if (v.midrolls == 1) { for (var jj = 1; jj < 8; jj++) { var zi = jj == 1 ? '' : jj; if (typeof v['midroll' + zi] == 'string') { if (v['midroll' + zi].substr(0, 3) == 'prt') { if (exist(v['partnermidrolltimes' + zi]) && exist(v['midroll' + zi])) { if (v['partnermidrolltimes' + zi] != '') { !o.midrollo ? o.midrollo = [] : ''; var z = v['partnermidrolltimes' + zi].split(','); for (var j = 0; j < z.length; j++) { var nomd = false; for (var j2 = 0; j2 < o.midrollo.length; j2++) { if (o.midrollo[j2].time == trim(z[j])) { o.midrollo[j2].vast = o.midrollo[j2].vast + ' ' + v['partnermidrollor'] + ' ' + v['midroll' + zi]; nomd = true; } } !nomd ? o.midrollo.push({ time: trim(z[j]), vast: v['midroll' + zi] }) : ''; } } } } } } } }
		o.prted = true;
	}
	function fd0(s) {
		if (s.indexOf(".") == -1) {
	...
	function Init() {
		...
		if (o.u != "" && !stop) {
			v = UpdateObject(
				v,
				typeof o.u != "object" ? { "screencolor": "000000", "toolbar": { "color": "172322", "hide": 1, "margin": "-7 10 11 83", "gradient": 0, "animation": "none", "a": "0.75", "paddingtop": 10, "rounding": 3, "h": 40, "clickarea": 0, "leftandrightpadding": 10, "hideleavetimeout": 4 }, "control_title": { "order": 1, "on": 1, "action": "title", "type": "text", "position": "top-left", "click": 0, "hand": 0, "text": "", "var": "title", "hide": 1, "hideonplay": 1, "animation": "position", "bg": 1, "bga": "1", "bgpadding": "6 6 6 6", "bgcolor": "172322", "title": "", "margin": "10 0 0 10", "color": "00adef", "fontsize": 16, "bgborder": 0, "bgbordercolor": "ff00ff" }, "control_line": { "order": 4, "on": 1, "type": "shape", "action": "line", "h": 9, "rounding": 0, "w": 110, "a": 1, "abg": "0", "aload": "1", "aover": "-1", "color": "00adef", "colorbg": "ffffff", "colorload": "666666", "colorover": "ffffff", "buffer": { "on": 0, "color": "ffffff", "a": 0.5 }, "position": "controls", "margin": "0 15 8 30", "handle": 1, "bgpadding": "3 0 -1 2", "tip": 1, "hide": 1, "hideonlive": 1, "bg": 1, "bgborder": 1, "bgbordercolor": "ffffff", "bgcolor": "172322", "bga": "0.3", "value": 0, "valuebgcolor": "ffffff", "valuepadding": "3 3 3 3", "valuetop": 5, "valuebottom": 11, "valuecolor": "000000", "valuesize": 12, "valuebg": 1, "valuemargin": "0 0 10 0", "tipfontsize": 12, "customwidth": 0, "clickarea": 0, "click": 1, "handlehide": 1, "handleaover": "-1", "toptip": 0, "tippointer": 0, "ontop": 1, "iconmargin": "0 0 0 0", "linetipmarginbottom": 5, "tippadding": "3 5 3 5", "tipbga": "0.3", "tipletterspacing": 0, "tipbgrounding": 3, "clickscalex": "1", "clickmargin": "0 0 0 0", "hand": 1, "dom": "timeline" }, "control_play": { "order": 2, "on": 1, "icon": "<svg width='20' height='20'><g transform='translate(5, 3)'><polyline points='0.59375 0.48438 0.5625 13.51563 11.4375 7 0.59375 0.48438' fill='#ffffff'/></g></svg>", "icon2": "<svg width='20' height='20'><g fill-rule='nonzero' transform='translate(5, 4)'><rect x='0' y='0' width='3.5' height='12' fill='#ffffff'/><rect x='6.5' y='0' width='3.5' height='12' fill='#ffffff'/></g></svg>", "icon3": "<svg width='20' height='20'><g transform='translate(2, 3)'><path d='M16,7.13661132 L16,7.10916945 L15.2081785,7.10916945 L14.275093,7.10916945 C14.275093,3.19912625 11.063197,0 7.13754645,0 C3.21189591,0 0,3.19912625 0,7.10916945 C0,11.0192126 3.21189591,14.2183389 7.13754645,14.2183389 L7.13754645,12.4410465 C4.19330855,12.4410465 1.78438662,10.0417018 1.78438662,7.10916945 C1.78438662,4.17663705 4.19330855,1.77729236 7.13754645,1.77729236 C10.0817844,1.77729236 12.4907063,4.17663705 12.4907063,7.10916945 L10.6445167,7.10916945 L13.3828996,11.5524004 L16,7.13661132 Z' fill='#ffffff'></path></g></svg>", "action": "play", "action2": "pause", "type": "svg", "scale": "1.6", "scaleover": 1.5, "margin": "4 5 13 12", "bgcolorover": "00adef", "bg": 1, "bgcolor": "172322", "bgpadding": "1 10 2 10", "bgo": "0.2", "bga": "0.7", "bgaover": "0.7", "iconsreplay": 0, "clickarea": 0, "click": 1, "flipx": 0, "flipy": 0, "a": "1", "iconscolor": "ffffff", "iconscolorover": "-1", "bgborder": 0, "aover": "0.7" }, "control_mute": { "order": 5, "on": 1, "icon": "<svg width='20' height='20'><g fill='#000000' transform='translate(3, 2)'><polygon fill-rule='nonzero' points='8.8817842e-16 4.3746 8.8817842e-16 10.62539 3.10029 10.62539 7.74143 15 7.74419 0 3.10237 4.37461 1.77635684e-15 4.37461 1.77635684e-15 4.3746' fill='#ffffff'/><path d='M10.44167,3.62185 C10.17405,3.31419 9.74434,3.31419 9.47808,3.62343 C9.21251,3.93268 9.21251,4.43332 9.47944,4.74335 L9.47944,4.74178 C10.06713,5.42512 10.42941,6.36234 10.42941,7.40396 C10.42941,8.44479 10.06781,9.37885 9.4808,10.06219 C9.2125,10.36985 9.2125,10.87049 9.47944,11.18131 C9.61223,11.33554 9.78657,11.41304 9.9609,11.41304 C10.13591,11.41304 10.31024,11.33554 10.44303,11.18131 C11.27519,10.21641 11.79138,8.87583 11.7907,7.40396 C11.79138,5.92892 11.27315,4.58676 10.44167,3.62186 L10.44167,3.62185 Z' id='pjs_volume_element1' fill='#ffffff'/><path d='M11.99413,1.86278 C11.72289,2.17257 11.72289,2.67489 11.99413,2.98309 C12.99747,4.13271 13.61608,5.71413 13.61608,7.46829 C13.61608,9.22085 12.99747,10.80149 11.99552,11.9519 C11.72427,12.26089 11.72427,12.76243 11.99552,13.07221 C12.13045,13.22671 12.3076,13.30435 12.48543,13.30435 C12.66256,13.30435 12.83971,13.22671 12.97464,13.07221 C14.22569,11.63894 15.00138,9.65345 15,7.46829 C15.00069,5.28154 14.225,3.29446 12.97187,1.86278 C12.69993,1.55299 12.2633,1.55299 11.99413,1.86278 L11.99413,1.86278 Z' id='pjs_volume_element2' fill='#ffffff'/></g></svg>", "icon2": "<svg width='20' height='20'><g fill-rule='nonzero' fill='#000000' transform='translate(3, 2)'><polygon points='8.8817842e-16 4.3746 8.8817842e-16 10.62539 3.10029 10.62539 7.74143 15 7.74419 0 3.10237 4.37461 1.77635684e-15 4.37461 1.77635684e-15 4.3746' fill='#ffffff'/><path d='M11.9267767,6.64744791 L9.87932726,4.59999847 L9,5.47932573 L11.0474494,7.52677517 L9,9.57422461 L9.87932726,10.4535519 L11.9267767,8.40610243 L13.9742261,10.4535519 L14.8535534,9.57422461 L12.806104,7.52677517 L14.8535534,5.47932573 L13.9742261,4.59999847 L11.9267767,6.64744791 Z' fill='#ffffff'/></g></svg>", "action": "mute", "action2": "unmute", "type": "svg", "margin": "0 0 8 0", "clickarea": 0, "clickscalex": "0.7", "clickmargin": "0 0 0 5", "displayvolume": 1, "flipy": 0, "tip": 0, "flipx": 0, "click": 1, "clickscaley": "0.9" }, "control_volume": { "order": 6, "on": 1, "type": "shape", "action": "volume", "h": 14, "rounding": 0, "customwidth": 1, "w": 28, "a": 1, "abg": "0.3", "aover": "0", "color": "ffffff", "colorbg": "ffffff", "colorover": "ffffff", "hide": 0, "hideoutmute": 1, "rotation": "0", "bgpadding": "5 0 5 0", "bg": 0, "handle": 0, "margin": "0 0 9 6", "customdesign": 1, "customdesignsvg": "<svg width='31px' height='29px' viewBox='0 -3 31 8' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'><g id='Group' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd' transform='translate(0.000000, -3.000000)'><rect fill='#00adef' x='0' y='0' width='3' height='22'></rect><rect fill='#00adef' x='6' y='0' width='3' height='22'></rect><rect fill='#00adef' x='12' y='0' width='3' height='22'></rect><rect fill='#00adef' x='18' y='0' width='3' height='22'></rect><rect fill='#00adef' x='24' y='0' width='3' height='22'></rect></g></svg>", "clickarea": 0, "click": 1, "value": 0, "clickscalex": "1", "tip": 0, "toptip": 0, "tippointer": 0, "tippadding": "3 5 3 5", "tipbga": "0.3", "tipfontsize": 12, "tipbgrounding": 3, "clickmargin": "0 0 0 0", "valuebg": 0, "valuemargin": "0 0 0 0" }, "control_time": { "order": 7, "on": 1, "action": "time", "type": "text", "text": "00:00:00", "fontsize": 10, "margin": "0 0 9 10", "click": 0, "separator": "/", "clickarea": 0, "inversetime": 0, "showduration": 0, "showboth": 0, "bold": 0, "animation": "none", "hide": 0, "rotation": "0", "bg": 0, "bgcolor": "000000", "minw": -1 }, "control_duration": { "order": 8, "on": 1, "action": "duration", "type": "text", "text": "/ 00:00:00", "fontsize": 10, "margin": "0 0 9 -1", "click": 0, "letterspacing": "0", "bg": 0 }, "control_buffer": { "order": 9, "on": 1, "icon": "<pjsdiv class='loader(rand)'></pjsdiv>|||.loader(rand), .loader(rand):after {display:block;border-radius: 50%; width: 5em; height: 5em; } .loader(rand){ margin: 60px auto; font-size: 10px; position: relative; text-indent: -9999em; border-top: 0.8em solid rgba(255, 255, 255, 0.3); border-right: 0.8em solid rgba(255, 255, 255, 0.3); border-bottom: 0.8em solid rgba(255, 255, 255, 0.3); border-left: 0.8em solid (color); transform: translateZ(0); animation: anim(rand) 1.1s infinite linear; } @keyframes anim(rand) { 0% { transform: rotate(0deg); } 100% { transform: rotate(360deg); } }", "action": "buffer", "type": "css", "position": "center", "scale": "1", "click": 0, "hide": 1, "margin": "0 0 0 0", "nicn": "17", "rotation": "45", "a": "0.3", "color": "e0e0e0" }, "control_settings": { "order": 11, "on": 1, "icon": "<svg width='20' height='20'><g fill-rule='nonzero' transform='translate(1, 1)'><path d='M9.95921636,0 L11.0734352,2.42298075 L12.084278,2.97683675 L14.5654263,1.86912475 L16.0013553,3.35766689 L15.1972647,5.84141709 L15.4154756,6.83068435 L17.8737063,7.7883911 L18,9.84229954 L15.5533514,10.8000063 L15.0708477,11.8384089 L16.0816905,14.3422093 L14.6566042,15.8135479 L12.1531543,14.7692045 L11.0274766,15.2422408 L10.0855101,17.60767 L8.06382454,17.7 L6.98410547,15.2884058 L5.8124692,14.7807148 L3.44615574,15.8537721 L1.96426811,14.4345393 L2.92927551,11.8845739 L2.36631345,10.8230269 L0,9.89997483 L0.0230409069,7.82304578 L2.44677181,6.84231842 L2.94073435,5.84141709 L1.88393297,3.35766689 L3.33132085,1.89226913 L5.86988664,2.89614086 L6.97264662,2.4807798 L7.9375308,0.0460412136 L9.95921636,0 Z M8.84993873,6 C7.27603345,6 6,7.27601328 6,8.84993974 C6,10.4239867 7.27603345,11.7 8.84993873,11.7 C10.4239666,11.7 11.7,10.4239867 11.7,8.84993974 C11.7,7.27601328 10.4239666,6 8.84993873,6 Z' fill='#ffffff'/></g></svg>", "action": "settings", "position": "controls-right", "margin": "0 10 8 10", "type": "svg", "scale": "0.9", "iconscolor": "ffffff", "iconscolorover": "00adef", "hdicon": 1, "clickarea": 0 }, "control_playlist": { "order": 12, "on": 1, "icon": "<svg width='20' height='20'><g transform='translate(2, 3)'><path d='M0,0 L16,0 L16,2 L0,2 L0,0 Z M0,6 L16,6 L16,8 L0,8 L0,6 Z M0,12 L16,12 L16,14 L0,14 L0,12 Z' fill='#ffffff'/></g></svg>", "action": "playlist", "position": "left", "margin": "0 0 0 20", "bg": 1, "scale": "1.5", "type": "svg", "animation": "position", "bgpadding": "3 3 3 3", "bga": "0.7", "bgaover": "1", "tip": 0, "bgcolor": "172322", "bgo": "0.2", "bgcolorover": "-1", "iconscolor": "00adef" }, "control_full": { "order": 13, "on": 1, "icon": "<svg width='18px' height='16px' viewBox='242 3 18 16' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'><g id='fullscreen13' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd' transform='translate(242.199997, 3.000000)'><polyline  fill='#ffffff' points='0.760742188 5.56931825 0.760742188 0.236905115 5.75521208 0.236905115 4.35163424 1.85221011 7.21999784 4.60187722 5.29384823 6.71019522 2.28730187 3.89382197'></polyline><polygon fill='#ffffff' points='16.8101563 5.44088458 16.8101563 0.10847144 11.8156864 0.10847144 13.2192642 1.72377644 10.3509006 4.47344355 12.2770502 6.58176154 15.2835966 3.7653883'></polygon><polygon fill='#ffffff' points='16.8101563 10.5225516 16.8101563 15.8549648 11.8156864 15.8549648 13.2192642 14.2396598 10.3509006 11.4899927 12.2770502 9.38167466 15.2835966 12.1980479'></polygon><polygon  fill='#ffffff' points='0.760742188 10.6509853 0.760742188 15.9833984 5.75521208 15.9833984 4.35163424 14.3680934 7.21999784 11.6184263 5.29384823 9.51010834 2.28730187 12.3264816'></polygon></g></svg>", "icon2": "\n<svg width='18px' height='16px' viewBox='262 3 18 16' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'><g stroke='none' stroke-width='1' fill='none' fill-rule='evenodd' transform='translate(262.199997, 3.000000)'><polygon fill='#ffffff' transform='translate(3.990370, 3.473550) scale(-1, -1) translate(-3.990370, -3.473550) ' points='0.760742188 5.56931825 0.760742188 0.236905115 5.75521208 0.236905115 4.35163424 1.85221011 7.21999784 4.60187722 5.29384823 6.71019522 2.28730187 3.89382197'></polygon><polygon fill='#ffffff' transform='translate(13.580528, 3.345116) scale(-1, -1) translate(-13.580528, -3.345116) ' points='16.8101563 5.44088458 16.8101563 0.10847144 11.8156864 0.10847144 13.2192642 1.72377644 10.3509006 4.47344355 12.2770502 6.58176154 15.2835966 3.7653883'></polygon><polygon fill='#ffffff' transform='translate(13.580528, 12.618320) scale(-1, -1) translate(-13.580528, -12.618320) ' points='16.8101563 10.5225516 16.8101563 15.8549648 11.8156864 15.8549648 13.2192642 14.2396598 10.3509006 11.4899927 12.2770502 9.38167466 15.2835966 12.1980479'></polygon><polygon fill='#ffffff' transform='translate(3.990370, 12.746753) scale(-1, -1) translate(-3.990370, -12.746753) ' points='0.760742188 10.6509853 0.760742188 15.9833984 5.75521208 15.9833984 4.35163424 14.3680934 7.21999784 11.6184263 5.29384823 9.51010834 2.28730187 12.3264816'></polygon>\n    </g>\n</svg>", "action": "fullscreen", "action2": "normalscreen", "type": "svg", "position": "controls-right", "margin": "0 10 7 0", "scale": "0.9", "iconscolor": "ffffff", "iconscolorover": "00adef", "hide": 1, "hideuntilstartedios": 1, "hideonmobile": 0, "hideondesktop": 0 }, "control_start": { "order": 14, "position": "center", "scale": 2, "on": 1, "icon": "<svg width='20' height='20'><g transform='translate(5, 3)'><polyline points='0.59375 0.48438 0.5625 13.51563 11.4375 7 0.59375 0.48438' fill='#ffffff'/></g></svg>", "icon3": "<svg width='20' height='20'><g transform='translate(2, 3)'><path d='M16,7.13661132 L16,7.10916945 L15.2081785,7.10916945 L14.275093,7.10916945 C14.275093,3.19912625 11.063197,0 7.13754645,0 C3.21189591,0 0,3.19912625 0,7.10916945 C0,11.0192126 3.21189591,14.2183389 7.13754645,14.2183389 L7.13754645,12.4410465 C4.19330855,12.4410465 1.78438662,10.0417018 1.78438662,7.10916945 C1.78438662,4.17663705 4.19330855,1.77729236 7.13754645,1.77729236 C10.0817844,1.77729236 12.4907063,4.17663705 12.4907063,7.10916945 L10.6445167,7.10916945 L13.3828996,11.5524004 L16,7.13661132 Z' fill='#ffffff'></path></g></svg>", "action": "play", "type": "svg", "bg": 1, "bgcolor": "1daeec", "bgo": "0.2", "bgpadding": "5 12 5 10", "iconmargin": "0 0 0 4", "bga": "1", "bgaover": "0.7", "scaleover": "-1", "hide": 1, "hideonplay": 1, "hideonyoutube": 1, "iconscolor": "-1", "bgcolorover": "-1", "clickarea": 0, "clickscaley": "1", "animation": "none", "iconscolorover": "ffffff", "aover": "0.7", "margin": "0 0 0 0" }, "control_live": { "order": 3, "on": 1, "text": "live", "letterspacing": 2, "action": "live", "type": "text", "hand": 0, "click": 0, "fontsize": 10, "margin": "0 0 8 20", "a": 0.5, "hide": 1, "hideonvod": 1 }, "control_stop": { "order": 15, "on": 0, "icon": "<svg width='20' height='20'><g transform='translate(4, 4)'><rect x='0' y='0' width='12' height='12' fill='#ffffff'/></g></svg>", "action": "stop", "type": "svg", "bg": 0 }, "control_prev": { "order": 16, "on": 0, "icon": "<svg width='20' height='20'><g transform='translate(5.5, 5)'><path d='M8.99999,10.43749 L8.99999,10.4375 L2,5.21875 L8.99999,0 L8.99999,10.43749 Z M0,0 L2,0 L2,10.24983 L0,10.24983 L0,0 Z' fill='#ffffff'/></g></svg>", "action": "prev", "type": "svg", "scale": 1.2, "position": "controls-bottom", "margin": "0 0 0 15" }, "control_next": { "order": 17, "on": 0, "icon": "<svg width='20' height='20'><g transform='translate(5, 5)'><path d='M0.46948,1e-05 L0.46948,1e-05 L0.46948,0 L7.46947,5.21875 L0.46948,10.4375 L0.46948,1e-05 Z M7.53052,0 L9.53052,0 L9.53052,10.62482 L7.53052,10.62482 L7.53052,0 Z' fill='#ffffff'/></g></svg>", "action": "next", "type": "svg", "scale": 1.2, "position": "controls-bottom", "margin": "0 0 0 15" }, "control_share": { "order": 18, "on": 0, "icon": "<svg width='20' height='20'><g fill='#ffffff' transform='translate(1, 2)'><path d='M17.7638875,0.170942228 C17.5104093,-0.0435393255 17.1009445,-0.0630376486 16.3990049,0.151443905 L16.3990049,0.151443905 C15.9115468,0.30743049 11.5829191,1.94528963 7.76124776,3.5246538 C4.3295429,4.94803138 1.5412827,6.19592406 1.20981121,6.35191064 C0.839343069,6.46890058 0.0399118236,6.8198704 0.000915177477,7.36582344 C-0.0185831456,7.71679326 0.2738917,8.02876643 0.839343069,8.28224463 C1.44379108,8.59421779 4.11506135,9.49114066 4.68051271,9.66662556 C4.87549594,10.3295685 6.02589701,14.2097348 6.08439198,14.4437147 C6.16238527,14.7946845 6.39636514,14.9896678 6.51335508,15.0676611 C6.53285341,15.0871594 6.57185005,15.126156 6.6108467,15.1456543 C6.66934167,15.184651 6.74733496,15.2041493 6.84482657,15.2041493 C6.98131484,15.2041493 7.13730142,15.1456543 7.27378968,15.0481627 C7.99522764,14.463213 9.24312031,13.1568254 9.59409013,12.7863573 C11.1344577,13.9952533 12.8113134,15.3406376 12.9673,15.4966242 L12.9867983,15.5161225 C13.3572665,15.8280957 13.7472329,16.0035806 14.0982028,16.0035806 C14.2151927,16.0035806 14.3321826,15.9840822 14.4491726,15.9450856 C14.8586374,15.8085973 15.1511122,15.4186309 15.2486038,14.8921761 C15.2486038,14.8726778 15.2681021,14.7946845 15.3070988,14.6581963 C15.9700418,11.7724445 16.4964965,9.23766246 16.9254596,7.11234524 C17.3349244,5.02602467 17.6663959,2.97870075 17.8613791,1.88679466 C17.9003758,1.61381814 17.9393724,1.39933658 17.9588707,1.26284832 C18.0173657,0.872881859 18.0563623,0.424420428 17.7638875,0.170942228 Z M5.0899775,9.60813059 L14.3906776,3.4466605 C14.4101759,3.42716218 14.4491726,3.40766386 14.4686709,3.38816553 L14.4686709,3.38816553 C14.4881692,3.38816553 14.4881692,3.36866721 14.5076675,3.36866721 C14.5271659,3.36866721 14.5271659,3.36866721 14.5466642,3.34916889 C14.5271659,3.36866721 14.5076675,3.42716218 14.4686709,3.46615883 L12.1093738,5.66946933 C10.4715147,7.17084021 8.32669913,9.14017084 6.90332154,10.4270602 C6.90332154,10.4270602 6.90332154,10.4270602 6.90332154,10.4465585 L6.88382322,10.4660568 C6.88382322,10.4660568 6.88382322,10.4855551 6.8643249,10.4855551 C6.8643249,10.5050535 6.8643249,10.5050535 6.84482657,10.5245518 L6.84482657,10.5440501 C6.84482657,10.5440501 6.84482657,10.5440501 6.84482657,10.5635484 C6.74733496,11.6554545 6.57185005,13.5272935 6.49385676,14.3657214 C6.49385676,14.3657214 6.49385676,14.3657214 6.49385676,14.3462231 C6.41586347,14.1122432 5.32395738,10.3880635 5.0899775,9.60813059 Z' fill='#ffffff'></path></g></svg>", "action": "share", "type": "svg", "position": "top-right", "margin": "15 15 0 0", "bg": 1, "bgo": "0.2", "scale": 1, "bgpadding": "6 6 6 6", "bga": 0.3, "bgaover": "1", "animation": "position", "ease": "elastic", "bgcolor": "172322", "bgcolorover": "00adef" }, "lang": "ru", "settings": { "settings4": 1, "margin": "0 10 15 0", "valuecolor": "00adef", "settings4action": "speed", "bgcolor": "172322", "bgcolorover": "172322", "bgaover": "0.8", "rounding": 3, "hmaxk": 40, "settings1hide": 0, "settings5": 1, "settings5action": "airplay", "hidearrow": 0, "always": 0, "showovercontrol": 0, "show1value": 0, "fontsize": 13, "headfontsize": 14, "customspeeds": 0, "settings2action": "scale", "settings2": 1, "scale": 3, "valuefontsize": 11, "letterspacing": 0 }, "playlist": { "valuecolor": "00adef", "rounding": 0, "position": "left", "bgcolor": "172322", "bga": "0.7", "historybgcolor": "172322", "bgcolorover": "172322", "bgover": "0.9", "historybga": "-1", "aover": "-1", "bgaover": "0.8", "hidecontrol": 1 }, "rightclick": 1, "rc_custom": 1, "svgline": { "svg": "<svg width='21px' height='8px' viewBox='0 -3 21 8' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'><g id='Group' stroke='none' stroke-width='1' fill='none' fill-rule='evenodd' transform='translate(0.000000, -3.000000)'><rect fill='#ED0000' x='0' y='0.975984186' width='3' height='7'></rect><rect id='Rectangle' fill='#ED0000' x='6' y='0.975984186' width='3' height='7'></rect><rect id='Rectangle' fill='#ED0000' x='12' y='0.975984186' width='3' height='7'></rect><rect id='Rectangle' fill='#ED0000' x='18' y='0.975984186' width='3' height='7'></rect></g></svg>" }, "log": 0, "share3": "", "reload": 1, "reloadtimeout": 25, "reloadstart": 0, "reloadlive": 0, "nativecontrolsmobile": 0, "playerwidth": 640, "rc_labelurl": "https://rezka.ag", "rc_label": "HDREZKA", "alertspaddingv": 10, "alertspaddingh": 20, "alertsbga": "1", "alertsbgcolor": "e1e289", "alertscolor": "222222", "alertsfontsize": 14, "alert404": 1, "alert404text": "Ошибка: видеопоток не найден. Пожалуйста, сообщите нам об этом в комментариях!", "rc_version": 0, "version": -1, "vast": 1, "prerolls": 1, "vast_preroll_limit": 160, "vast_preroll_counter": 1, "partnerprerollor": "and", "aspect": "off", "changeheight": 0, "changevastheight": 0, "change2playlist": 0, "covervideo": 0, "eventstracker": 1, "eventstrackervast": 1, "hlsconfig": { "maxBufferLength": 420 }, "chromecast": { "on": 1, "message": 1, "sub": 1, "receiver": 0 }, "sharetitle": 1, "hlssubtracks": 0, "preloadhls": 1, "hlslowquality": 0, "control_7Ubla": { "on": 1, "order": 19, "action": "custom", "icon": "<svg width='20' height='20'><g fill-rule='nonzero' fill='#ffffff' transform='translate(1.5, 3)'><path d='M3.29174805,11.4443359 L2.52783203,11.4443359 C1.96017608,11.4443359 1.5,10.9841599 1.5,10.4165039 L1.5,2.77734375 C1.5,2.20968779 1.96017608,1.74951172 2.52783203,1.74951172 L14.7504883,1.74951172 C15.3181442,1.74951172 15.7783203,2.20968779 15.7783203,2.77734375 L15.7783203,10.4165039 C15.7783203,10.9841599 15.3181442,11.4443359 14.7504883,11.4443359 L13.9865723,11.4443359 C13.7104299,11.4443359 13.4865723,11.6681936 13.4865723,11.9443359 C13.4865723,12.2204783 13.7104299,12.4443359 13.9865723,12.4443359 L14.7504883,12.4443359 C15.870429,12.4443359 16.7783203,11.5364446 16.7783203,10.4165039 L16.7783203,2.77734375 C16.7783203,1.65740304 15.870429,0.749511719 14.7504883,0.749511719 L2.52783203,0.749511719 C1.40789133,0.749511719 0.5,1.65740304 0.5,2.77734375 L0.5,10.4165039 C0.5,11.5364446 1.40789133,12.4443359 2.52783203,12.4443359 L3.29174805,12.4443359 C3.56789042,12.4443359 3.79174805,12.2204783 3.79174805,11.9443359 C3.79174805,11.6681936 3.56789042,11.4443359 3.29174805,11.4443359 Z' fill='#ffffff'></path><path d='M5.88710088,14.5 L11.3912194,14.5 L8.63916016,11.1975289 L5.88710088,14.5 Z M9.0232708,10.0964117 L12.8428509,14.6799078 C13.1142371,15.0055713 12.8826591,15.5 12.4587402,15.5 L4.81958008,15.5 C4.39566125,15.5 4.16408322,15.0055713 4.43546944,14.6799078 L8.25504952,10.0964117 C8.45494707,9.85653464 8.82337324,9.85653464 9.0232708,10.0964117 Z' fill='#ffffff'></path></g></svg>", "type": "svg", "position": "top-left", "margin": "10 0 0 10", "link": 1, "linkurl": "airplay", "hide": 1, "hideonleave": 1, "hideonfullscreen": 1, "hideuntilmeta": 1, "iconscolor": "ffffff", "iconscolorover": "00adef" }, "intros": 0, "introclickable": 0, "introclosetime": "-1", "introtxt": 0, "introskiptime": "-1", "introtitle": 0, "intronocontrols": 0, "nativehlsinedge": 1, "nativehlsinsafari": 1, "control_0AZKo": { "on": 1, "order": 20, "action": "custom", "icon": "<svg width='20' height='20'><g fill-rule='nonzero' fill='#ffffff' transform='translate(-38.5, 3)'><path d='M40,14.7272727 L42.4545455,14.7272727 C42.4545455,13.3690909 41.3581818,12.2727273 40,12.2727273 L40,14.7272727 Z M40,10.6363636 C42.2581818,10.6363636 44.0909091,12.4690909 44.0909091,14.7272727 L45.7272727,14.7272727 C45.7272727,11.5609091 43.1663636,9 40,9 L40,10.6363636 Z M40,7.36363636 C44.0663636,7.36363636 47.3636364,10.6609091 47.3636364,14.7272727 L49,14.7272727 C49,9.75272727 44.9663636,5.72727273 40,5.72727273 L40,7.36363636 Z M41.6363636,0 C40.7363636,0 40,0.736363636 40,1.63636364 L40,4.09090909 L41.6363636,4.09090909 L41.6363636,1.63636364 L56.3636364,1.63636364 L56.3636364,13.0909091 L50.6363636,13.0909091 L50.6363636,14.7272727 L56.3636364,14.7272727 C57.2636364,14.7272727 58,13.9909091 58,13.0909091 L58,1.63636364 C58,0.736363636 57.2636364,0 56.3636364,0 L41.6363636,0 Z' fill='#ffffff'></path></g></svg>", "type": "svg", "position": "top-left", "margin": "40 0 0 10", "link": 1, "linkurl": "chromecast", "hide": 1, "hideonleave": 1, "scaleover": "-1", "iconscolor": "ffffff", "iconscolorover": "00adef", "hideuntilmeta": 1, "hideonfullscreen": 0, "hidetime": 0, "hideonleaveandplay": 1 }, "control_DYo2o": { "on": 1, "order": 21, "action": "custom", "icon": "<svg width='20' height='20'><g transform='translate(0, 2)'><polygon fill-rule='nonzero' points='1.85008844 1.51464844 18.2421138 1.51464844 18.2421138 7.74121094 19.2421138 7.74121094 19.2421138 0.514648438 0.850088443 0.514648438 0.850088443 11.7244572 9.16539331 11.7758693 9.17157603 10.7758885 1.85008844 10.7306209' fill='#ffffff'></polygon><rect x='10.5' y='9' width='9.5' height='6' fill='#ffffff'></rect><path d='M8.49517931,6.9934339 L4.58268904,3.10539669 L3.87780235,3.81471662 L7.75590296,7.6685791 L5.14025649,7.6685791 L5.14025649,8.6685791 L9.49517931,8.6685791 L9.49517931,4.64446771 L8.49517931,4.64446771 L8.49517931,6.9934339 Z' fill-rule='nonzero' fill='#ffffff'></path></g></svg>", "type": "svg", "position": "top-right", "margin": "10 10 0 0", "link": 1, "linkurl": "api:pipwebkit", "linkpause": 0, "hide": 1, "hideonfullscreen": 1, "hideonleaveandplay": 1, "hideonleave": 0, "hideuntilmeta": 1, "hideonmobile": 0, "iconscolor": "ffffff", "iconscolorover": "00adef" }, "hotkey": { "updown": "volume", "plusminus": "scale", "scale": 1, "seeksides": 1, "wheelstep": "0.1", "vol": "0.1", "on": 1, "seeksidesmob": 1, "seeksidesec": 5 }, "reloadjustevent": 1, "pip": { "on": 0 }, "finishrewind": 0, "hlsdebug": 0, "nativenodownload": 1, "nativeontv": 0, "nativenotipad": 0, "nativefullios": 1, "timestore": 1, "timestoredontuse": 0, "timestorejustbut": 0, "preload": 0, "ab": 1, "postmessage": 1, "midrolls": 1, "vast_midrollrest": 900, "vast_midroll_limit": 160, "customyterrors": 0, "yterrors": 1, "vimeo": 0, "fullonplay": 0, "vast_skip2_size": 16, "thumbs": 1, "thumb_border": 1, "rightmenu": 1, "sub_bottom": 50, "sub_off_title": "откл.", "sub_size": 14, "sub_size_fullscreen": 26, "sub_bgpadding": 5, "sub_bgo": 3, "control_VIym0": { "on": 1, "order": 10, "action": "custom", "icon": "<svg width='20' height='20'><g transform='translate(2, 4)'><path d='M7.42857143,7.76007326 C7.37484711,8.97619656 7.03297018,9.89682227 6.4029304,10.521978 C5.77289062,11.1471338 4.88401062,11.459707 3.73626374,11.459707 C2.5299085,11.459707 1.60561982,11.0628855 0.963369963,10.2692308 C0.32112011,9.47557601 2.22044605e-15,8.34371919 2.22044605e-15,6.87362637 L2.22044605e-15,5.07875458 C2.22044605e-15,3.61354579 0.332109011,2.48413095 0.996336996,1.69047619 C1.66056498,0.896821429 2.58363267,0.5 3.76556777,0.5 C4.92796674,0.5 5.81074179,0.824783077 6.41391941,1.47435897 C7.01709703,2.12393487 7.36019495,3.05677048 7.44322344,4.27289377 L5.28205128,4.27289377 C5.26251516,3.52075326 5.14652121,3.00183293 4.93406593,2.71611722 C4.72161066,2.4304015 4.33211516,2.28754579 3.76556777,2.28754579 C3.18925231,2.28754579 2.78144198,2.48900897 2.54212454,2.89194139 C2.30280711,3.29487381 2.17582425,3.95787084 2.16117216,4.88095238 L2.16117216,6.8956044 C2.16117216,7.95543875 2.2796081,8.68314821 2.51648352,9.07875458 C2.75335894,9.47436095 3.15994828,9.67216117 3.73626374,9.67216117 C4.30281114,9.67216117 4.69352762,9.53418941 4.90842491,9.25824176 C5.1233222,8.9822941 5.2454211,8.4829096 5.27472527,7.76007326 L7.42857143,7.76007326 Z M15.985348,7.76007326 C15.9316237,8.97619656 15.5897467,9.89682227 14.959707,10.521978 C14.3296672,11.1471338 13.4407872,11.459707 12.2930403,11.459707 C11.0866851,11.459707 10.1623964,11.0628855 9.52014652,10.2692308 C8.87789667,9.47557601 8.55677656,8.34371919 8.55677656,6.87362637 L8.55677656,5.07875458 C8.55677656,3.61354579 8.88888557,2.48413095 9.55311355,1.69047619 C10.2173415,0.896821429 11.1404092,0.5 12.3223443,0.5 C13.4847433,0.5 14.3675184,0.824783077 14.970696,1.47435897 C15.5738736,2.12393487 15.9169715,3.05677048 16,4.27289377 L13.8388278,4.27289377 C13.8192917,3.52075326 13.7032978,3.00183293 13.4908425,2.71611722 C13.2783872,2.4304015 12.8888917,2.28754579 12.3223443,2.28754579 C11.7460289,2.28754579 11.3382185,2.48900897 11.0989011,2.89194139 C10.8595837,3.29487381 10.7326008,3.95787084 10.7179487,4.88095238 L10.7179487,6.8956044 C10.7179487,7.95543875 10.8363847,8.68314821 11.0732601,9.07875458 C11.3101355,9.47436095 11.7167248,9.67216117 12.2930403,9.67216117 C12.8595877,9.67216117 13.2503042,9.53418941 13.4652015,9.25824176 C13.6800988,8.9822941 13.8021977,8.4829096 13.8315018,7.76007326 L15.985348,7.76007326 Z' fill='#ffffff'></path></g></svg>", "type": "svg", "position": "controls", "margin": "0 0 8 10", "link": 1, "linkurl": "settings#3", "dom": "cc", "scale": "1.2", "scaleover": "-1", "iconscolor": "ffffff", "iconscolorover": "00adef" }, "subtitle": "", "sub_lineheight": "1.9", "thumb_bottom": 33, "thumb_radius": 2, "thumb_bordercolor": "666666", "thumb_shadow": 0, "mobileseek": 0, "playsinlineonmobileiphone": 1, "vast_poster": 0, "vast_linktxt_size": 16, "vast_skip_size": 20, "vast_title_important": 1, "vast_titlebga": "0.5", "vast_timeout": 10, "vpaid_timeout": 10, "vast_title_size": 16, "fullonplaymobile": 0, "vast_push_waiting": 1, "rc_nobrand": 1, "tagcors": 1, "speedstore": 1, "sub_drag": 1, "sub_all": 0, "fileto": 15, "vast_volume": "0.6", "tryotherquality": 1, "base64": 1, "file3_separator": "//_//", "bk0": "$$#!!@#!@##", "bk1": "^^^!@##!!##", "bk2": "####^!!##!@@", "bk3": "@@@@@!##!^^^", "bk4": "$$!!@$$@^!@#$$@", "enc2": "h" } : o.u
			);
		}
